EMACS ?= emacs
TEST_FILES ?= tests/minuet-tests.el tests/minuet-diff-tests.el tests/minuet-duet-tests.el tests/minuet-duet-history-tests.el tests/minuet-context-summary-tests.el
EL_FILES ?= minuet.el minuet-diff.el minuet-duet.el minuet-duet-history.el minuet-context-summary.el
